 ...
 * receives a plain collection of selected ids (not hydrated models — see
 * #37), so wrap $records back into that shape here.
 *
...
function assignCustomDomainToRecords(Collection $records, array $data): void
{
    ...
    $method->invoke(null, collect($records->modelKeys()), $data);
}
