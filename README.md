...
![Filament Short URL](https://raw.githubusercontent.com/jeffersongoncalves/filament-short-url/2.x/art/jeffersongoncalves-filament-short-url.png)
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-short-url/tests.yml?branch=2.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-short-url/actions?query=workflow%3Atests+branch%3A2.x)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-short-url/fix-php-code-style-issues.yml?branch=2.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-short-url/actions?query=workflow%3A%22Fix+PHP+code+style+issues%22+branch%3A2.x)
...
A complete Filament v4 admin layer for
...
```bash
composer require jeffersongoncalves/filament-short-url:"^2.0"
```
